...
| 워프홀 쌍 (`WarpHole`) | 항상 A/B 한 쌍으로 생성됩니다. 어느 한쪽에 진입하면 반대편 워프홀의 중심으로 순간이동하며, 사용 직후에는 쌍 전체가 일정 시간 비활성화됩니다. 쿨타임이 끝나야 어느 방향으로든 다시 사용할 수 있습니다. | A는 청록색 외곽과 보라색 코어, B는 보라색 외곽과 청록색 코어를 사용합니다. 두 워프홀 모두 밝은 링이 있으며, 쿨타임 중에는 한 쌍이 함께 어두워집니다. |
...
2. `SPACE DEVICES`: 블랙홀, 서로 연결된 워프홀 쌍과 공통 쿨타임, 공전·자전 장애물, 부스터, 연료 흡수 장치를 설명합니다.
